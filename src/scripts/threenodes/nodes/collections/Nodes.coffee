define (require) ->
  ...
  require 'cs!../models/components/Base'
  require 'cs!../models/components/Conditional'
  require 'cs!../models/components/Geometry'
  require 'cs!../models/components/Lights'
  require 'cs!../models/components/Materials'
  require 'cs!../models/components/Math'
  require 'cs!../models/components/PostProcessing'
  require 'cs!../models/components/Three'
  require 'cs!../models/components/ConstructiveSolidGeometry'
  require 'cs!../models/components/Utils'
  require 'cs!../models/components/Spread'
  require 'cs!../models/components/Particle'
  require 'cs!../models/components/Group'
