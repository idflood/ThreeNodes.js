  ...
  return NodeFieldTest = (function() {
    ...
    function NodeFieldTest(app) {
      ...
      test("Bool field", function() {
        ...
        return equals(nf.getValue(), true, "Boolfield kept previous value when wrong type is set");
      });
      test("Float field", function() {
        ...
        nf.setValue(false);
        return equals(nf.getValue(), 0, "Floatfield converted FALSE value to 0");
      });
      test("Color field", function() {
        ...
        return equals(nf.getValue().getHex(), new THREE.Color().setRGB(0.1, 0.2, 0.3).getHex(), "ColorField converted Vector3 value to Color");
      });
    }
